package dev.o8o1o5.tutorialmod.block;
...
public class ModBlocks {
    ...
    public static final DeferredBlock<Block> GARNET_ORE = registerBlock("garnet_ore",
            () -> new DropExperienceBlock(UniformInt.of(2, 4), BlockBehaviour.Properties.of().strength(3f).requiresCorrectToolForDrops().sound(SoundType.AMETHYST)));
